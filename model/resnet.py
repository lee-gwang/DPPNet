...
def resnet20(pretrained=False, num_classes=10, dataset='cifar10',  **kwargs):
    ...
    return model
def resnet32(pretrained=False, num_classes=10, dataset='cifar10',  **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def resnet18(pretrained=False, dataset='imagenet', **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def resnet34(pretrained=False, dataset='imagenet', **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def resnet50(pretrained=False, dataset='imagenet', **kwargs):
